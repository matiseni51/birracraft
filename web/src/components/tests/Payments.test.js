...
test("elements in Payments", () => {
  ...
  expect(screen.getByRole("heading", { name: "Quotas", level: 3 })).toBeInTheDocument();
  ...
  expect(screen.getByRole("columnheader", { name: "Quota number" })).toBeInTheDocument();
  expect(screen.getByRole("columnheader", { name: "Total quotas" })).toBeInTheDocument();
